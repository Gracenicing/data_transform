"""
将txt转成labelme标记的json
python main.py param1 param2 param3
param1 : txt文件所在的文件夹路径
param2： 保存json文件所在的文件夹路径
param3:  原始图像的路径
例如：
命令行输入：
C:/data_convert_tool/txt_transform_json/picture/txt C:/data_convert_tool/txt_transform_json/picture/json C:/data_convert_tool/txt_transform_json/picture/image
"""
