...
例如：
命令行输入：
python main.py C:/data_convert_tool/json_transform_txt/picture/json/ C:/data_convert_tool/json_transform_txt/picture/txt/ C:/data_convert_tool/json_transform_txt/picture/
...
#     json_path = r'C:/data_convert_tool/json_transform_txt/picture/json/' 
#     txt_path = r'C:/data_convert_tool/json_transform_txt/picture/txt/'
#     class_txt = r'C:/data_convert_tool/json_transform_txt/picture/'
#     get_class_index(json_path, class_txt)
#     main(json_path, txt_path, class_txt)